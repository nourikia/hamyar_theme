...
<div class="content-area">
    ...
    <section class="page-section">
        <div class="container">
            ...
            <div class="row product-single">
                <?php Class_View::render('product/gallery-product') ?>
                <div class="col-md-6">
                        ...
                        <div class="comments">
                            <div class="media comment">
                                <a href="#" class="pull-left comment-avatar">
                                    <img alt="" src="<?php echo Class_Asset::image('preview/shop/product-1-big.jpg'); ?>" class="media-object">
                                </a>
                                <div class="media-body">
    ...
    <?php endwhile;?>
    <?php endif; ?>
    <?php Class_View::render('product/related-products'); ?>
    <?php Class_View::render('product/brand-products'); ?>
